...
public class TeacherDetaisActivity extends BaseActivity {
    ...
    AutoListView teacherDetailsComment;
    ...
    public void initData() {
        headView = LayoutInflater.from(context).inflate(R.layout.activity_teacher_details_headview_layout, null);
    ...
    public void initView() {
        ...
        headViewHolder.teacherDetailsPic.setAdapter(pictureAdapter);
        ...
        teacherDetailsComment.addHeaderView(headView);
        teacherDetailsComment.setAdapter(studentCommentAdapter);
        teacherDetailsComment.setResultSize(listStudentComment.size());
    }

    @Override
    public void initListener() {
        //上拉
        teacherDetailsComment.setOnLoadListener(new AutoListView.OnLoadListener() {
            @Override
